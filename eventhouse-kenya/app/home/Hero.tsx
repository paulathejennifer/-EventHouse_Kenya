      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-16 pt-26">
        <div className="max-w-xl">
          ...
          <p className="font-sans text-warmgray text-sm md:text-base mb-8 max-w-md leading-loose">
            From luxurious weddings and elegant corporate events to intimate celebrations, 
            we bring your vision to life through bespoke décor, exquisite floral artistry, 
            and seamless event planning
          </p>
